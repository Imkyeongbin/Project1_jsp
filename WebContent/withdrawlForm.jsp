...
<body>
	...
	<div class="container" style="text-align: center; padding-top: 80px;">
		<label id="withdrawl">${user_info.user_nickname }님, 정말
			탈퇴하시겠습니까?<br> 탈퇴시 비밀번호를 입력해 주세요
		</label>
	</div>
	<form action="withdrawlPro.do" method="post">
		<div align="center" class="password">
			<input type="password" name="passwd"><br>
			<br>			
			<input type="submit" class="btn btn-danger" value="탈퇴하기"><button onclick="location.href='main.do'" class="btn">메인으로</button>
			<p></p>
		</div>
	</form>
	<br>
