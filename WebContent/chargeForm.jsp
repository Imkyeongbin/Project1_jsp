	...
	<br>
		...
		<script type="text/javascript">
			$(document).ready(function() {
				$("#check_charge").on("keyup", function() {
					$(this).val($(this).val().replace(/[^0-9]/g, ""));
				});

			});
		</script>
		<form action="pushRealMoney.do" name="frm">
			<label id="chargeForm">충전 금액을 입력해 주세요</label>
			<div>
				<input type="text" id="check_charge" placeholder="입금금액"
					name="charge_money" required="required"> <font
					style="font-family: 'Nanum Gothic Coding', 'gulim'; text-align: center; font-size: 20px;">원</font>
				<p></p>
				<input type="submit" id="submit_charge" class="btn btn-default" value="충전하기">
			</div>
		</form>
	</div>
	<br>
